...
2. With our inputs defined let's create a `StudentMutations.cs` file. The file contains the mutations AddStudent and EditStudent which does their job by using the entity framework.
