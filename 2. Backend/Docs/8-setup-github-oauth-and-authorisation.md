...
3. Let's create an Oauth Application using Github at [https://github.com/settings/developers](https://github.com/settings/developers)
   ...
   ![8-setup-github-oauth-and-authorisation/Untitled.png](8-setup-github-oauth-and-authorisation/Untitled.png)
   ...
   ![8-setup-github-oauth-and-authorisation/Untitled%201.png](8-setup-github-oauth-and-authorisation/Untitled%201.png)

   ![8-setup-github-oauth-and-authorisation/Untitled%202.png](8-setup-github-oauth-and-authorisation/Untitled%202.png)

4. Let's add our client ID and client secrets to `appsettings.Development.json`

   ![8-setup-github-oauth-and-authorisation/Untitled%203.png](8-setup-github-oauth-and-authorisation/Untitled%203.png)
...
10. Time to test our Login mutation. First log in with GitHub OAuth to create a new code.
    ...
    ![8-setup-github-oauth-and-authorisation/Untitled%204.png](8-setup-github-oauth-and-authorisation/Untitled%204.png)
    ...
    ![8-setup-github-oauth-and-authorisation/Untitled%205.png](8-setup-github-oauth-and-authorisation/Untitled%205.png)

    Check out [https://jwt.io/](https://jwt.io/) and use the Debugger to view the JWT decoded (base64)

    ![8-setup-github-oauth-and-authorisation/Untitled%206.png](8-setup-github-oauth-and-authorisation/Untitled%206.png)
...
![8-setup-github-oauth-and-authorisation/Untitled%207.png](8-setup-github-oauth-and-authorisation/Untitled%207.png)

The self request allows the user to request details of themself after they log in!

![8-setup-github-oauth-and-authorisation/Untitled%208.png](8-setup-github-oauth-and-authorisation/Untitled%208.png)

1. Let's update the old mutations to use the new authorisation settings. Example:
